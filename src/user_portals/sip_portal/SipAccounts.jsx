...
function SipAccounts({colorThem}) {
  ...
  useEffect(() => {
    if (selectedProduct) {
      const product = state?.getManagePayment?.Payment?.find(
                              ...
                              <ul className="p-0 w-50">
                                ...
                                <li className="w-100 px-1 mb-2">
                                  ...
                                  >
                                    ...
                                    {product?.map((item, item_value) => (
                                      <option key={item_value} value={item.id}>
                                        {item.name}
                                      </option>
                                    ))}
                                  </Form.Select>
                            ...
                            <div>
                              <ul>
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    displayRazorpay(total.toFixed(2))
