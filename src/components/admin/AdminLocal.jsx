...
import { createAdminLocal, getAdminLocal, updateAdminLocal } from "../../redux/actions/adminPortal/adminPortal_localAction";
...
function AdminLocal({ colorThem }) {
  ...
  const handleButtonClick = useCallback((row) => {
    ...
    setBillingRate(row.billing_policy);
  ...
  const rows = useMemo(() => {
    ...
    state?.getAdminLocal?.adminLOCAL &&
      state?.getAdminLocal?.adminLOCAL?.forEach((item, index) => {
        calculatedRows.push({
          id: index + 1,
  ...
  console.log('state?.getAdminLocal', state?.getAdminLocal)
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    ...
                    >
                      ...
                      <div className="">
                        ...
                        <div
                          style={{ margin: "auto" }}
                          className="billing_minute_mobile"
                        >
