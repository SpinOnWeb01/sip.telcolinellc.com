...
function ManageCampaign({colorThem}) {
...
<Button variant="contained" className="all_button_clr" color="primary" sx={{fontSize: '16px !impotant', background:'linear-gradient(180deg, #fb7804 0%, #D76300 100%) !important',marginTop:'20px', padding: '10px 20px !important', textTransform: 'capitalize !important'}}
onClick={handleClose}>
 Cancel
</Button>
