...
function Header({ colorThem, handleClick, mockDataTeam, radioValue }) {
  ...
  // Count CallType occurrences
  const callTypeCounts = mockDataTeam.reduce((acc, curr) => {
    acc[curr.CallType] = (acc[curr.CallType] || 0) + 1;
    return acc;
  }, {});
                    ...
                    {radioValue !== "" ? (
                      <>
                        <IconButton
                          ...
                          style={{ borderRight: "0" }}
                        >
                          Toll Free : &nbsp; {callTypeCounts["Toll-Free"] || 0}
                        </IconButton>
                        <IconButton
                          size="large"
                          aria-label="account of current user"
                    ...
                    {colorThem === "theme_white" ? (
                      <>
                        <Tooltip
                          ...
                          interactive
                        >
                          <IconButton onClick={() => handleClick("theme_blue")}>
                            {" "}
                            <DarkModeIcon
                              id="theme_white"
                              className={`${
                                colorThem === "theme_white" ? "active" : ""
                              }`}
                            />
                          </IconButton>
                        </Tooltip>
                      ...
                      <>
                        ...
                        >
                          <IconButton
                            onClick={() => handleClick("theme_white")}
                          >
                            {" "}
                            <NightlightIcon
                              id="theme_blue"
