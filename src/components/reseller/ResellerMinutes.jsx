...
import { getResellerRemainingMinutesList } from "../../redux/actions/adminPortal/adminPortal_listAction";
...
function ResellerMinutes({ colorThem }) {
                    ...
                    >
                      ...
                      <div className="">
                        ...
                        >
                          ...
                          {state?.getResellerRemainingMinutes?.remainingMinutes?.remaining_minutes ? (<>
                            <div  style={{margin:'auto'}} className="billing_minute">
<div style={{color:"white", padding:"8px", fontSize:"20px"}}>Remaining Minute: <span style={{color:'rgb(78 255 8)'}}>{state?.getResellerRemainingMinutes?.remainingMinutes?.remaining_minutes}</span></div>
</div></>) : (<>
  <div  style={{margin:'auto'}} className="billing_minute">
<div style={{color:"white", padding:"8px", fontSize:"20px"}}>Remaining Minute: <span style={{color:'rgb(78 255 8)'}}>{0}</span></div>
</div></>)}
...
export default ResellerMinutes;
