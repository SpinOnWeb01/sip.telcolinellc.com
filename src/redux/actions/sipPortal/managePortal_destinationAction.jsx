...
} from "../../constants/sipPortal/managePortal_destinationConstants";
import { toast } from "react-toastify";

export const getManageDid = (radioValue) => async (dispatch) => {
  ...
  try {
    ...
    let config = {
      ...
      url: `${api.dev}/api/userdidresource?is_active=${radioValue}`,
      headers: {
